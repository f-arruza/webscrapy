...
var i=t.fn.rowlink
t.fn.rowlink=function(i){return this.each(function(){var s=t(this),n=s.data("rowlink")
n||s.data("rowlink",n=new e(this,i))})},t.fn.rowlink.Constructor=e,t.fn.rowlink.noConflict=function(){return t.fn.rowlink=i,this},t(document).on("click.bs.rowlink.data-api",'[data-link="row"]',function(e){if(0===t(e.target).closest(".rowlink-skip").length){var i=t(this)
i.data("rowlink")||(i.rowlink(i.data()),t(e.target).trigger("click.bs.rowlink"))}})}(window.jQuery),function(t){"use strict"
...
n.DEFAULTS={mask:"",placeholder:"_",definitions:{9:"[0-9]",a:"[A-Za-z]","?":"[A-Za-z0-9]","*":"."}},n.prototype.init=function(){var e=this.options.definitions,i=this.mask.length
...
t.fn.inputmask=function(e){return this.each(function(){var i=t(this),s=i.data("inputmask")
s||i.data("inputmask",s=new n(this,e))})},t.fn.inputmask.Constructor=n,t.fn.inputmask.noConflict=function(){return t.fn.inputmask=a,this},t(document).on("focus.bs.inputmask.data-api","[data-mask]",function(){var e=t(this)
e.data("inputmask")||e.inputmask(e.data())})}(window.jQuery),function(t){"use strict"
...
t.fn.fileinput=function(e){return this.each(function(){var s=t(this),n=s.data("fileinput")
n||s.data("fileinput",n=new i(this,e)),"string"==typeof e&&n[e]()})},t.fn.fileinput.Constructor=i,t.fn.fileinput.noConflict=function(){return t.fn.fileinput=s,this},t(document).on("click.fileinput.data-api",'[data-provides="fileinput"]',function(e){var i=t(this)
if(!i.data("fileinput")){i.fileinput(i.data())
